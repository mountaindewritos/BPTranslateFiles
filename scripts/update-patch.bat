...
cd ..\..\..
node scripts\tx\compileJaText
node scripts\tx\fetchTranslation
node scripts\tx\updateDictionary
node scripts\tx\applyTranslation @rem Create translated server files

@rem Create translated .uassets
cd scripts\client\UE4localizationsTool
